...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans" style={{ paddingBottom: '80px' }}>
      ...
      {/* ======== الزر الأخضر في المنتصف ======== */}
      <div className="flex justify-center" style={{ margin: '20px 0' }}>
        <button
          onClick={handleOpenLink}
          className="bg-[#3b82f6] text-white rounded-full font-bold flex items-center justify-center shadow-lg cursor-pointer hover:bg-[#3b82f6]"
      ...
      <div className="flex gap-3 justify-between overflow-x-auto" style={{ padding: '0 20px', marginBottom: '20px', maxWidth: '100%' }}>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden flex-shrink-0" style={{ width: '45%', minWidth: '150px' }}>
          <img src="/p1.png" alt="صحبة صالحة" style={{ width: '100%', height: '150px', objectFit: 'cover' }} loading="lazy" />
          <p className="text-gray-800 text-center" style={{ fontSize: '12px', fontWeight: '500', padding: '8px 4px' }}>صحبة صالحة</p>
        </div>

        {/* كارت 2: حلقات قرآن */}
        <div className="bg-white rounded-lg shadow-md overflow-hidden flex-shrink-0" style={{ width: '45%', minWidth: '150px' }}>
          <img src="/p2.png" alt="حلقات قرآن" style={{ width: '100%', height: '150px', objectFit: 'cover' }} loading="lazy" />
          <p className="text-gray-800 text-center" style={{ fontSize: '12px', fontWeight: '500', padding: '8px 4px' }}>حلقات قرآن</p>
        </div>

        {/* كارت 3: أجواء صيفية */}
        <div className="bg-white rounded-lg shadow-md overflow-hidden flex-shrink-0" style={{ width: '45%', minWidth: '150px' }}>
          <img src="/p3.png" alt="أجواء صيفية" style={{ width: '100%', height: '150px', objectFit: 'cover' }} loading="lazy" />
          <p className="text-gray-800 text-center" style={{ fontSize: '12px', fontWeight: '500', padding: '8px 4px' }}>أجواء صيفية</p>
        </div>

        {/* كارت 4: لعب وتنافس */}
        <div className="bg-white rounded-lg shadow-md overflow-hidden flex-shrink-0" style={{ width: '45%', minWidth: '150px' }}>
          <img src="/p4.png" alt="لعب وتنافس" style={{ width: '100%', height: '150px', objectFit: 'cover' }} loading="lazy" />
